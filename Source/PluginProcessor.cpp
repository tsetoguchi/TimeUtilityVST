...
double CurrentlyAudioProcessor::getTailLengthSeconds() const
{
    return 0.0;
}
...
int CurrentlyAudioProcessor::getCurrentProgram()
{
    return 0;
}
...
void CurrentlyAudioProcessor::changeProgramName (int index, const juce::String& newName)
{
}

//==============================================================================
void CurrentlyAudioProcessor::prepareToPlay (double sampleRate, int samplesPerBlock)
{
...
#ifndef JucePlugin_PreferredChannelConfigurations
bool CurrentlyAudioProcessor::isBusesLayoutSupported (const BusesLayout& layouts) const
{
  #if JucePlugin_IsMidiEffect
...
void CurrentlyAudioProcessor::processBlock (juce::AudioBuffer<float>& buffer, juce::MidiBuffer& midiMessages)
{
...
void CurrentlyAudioProcessor::setStateInformation (const void* data, int sizeInBytes)
{
